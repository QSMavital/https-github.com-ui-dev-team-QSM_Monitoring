...
export const Atms = {
  ...
  Transactions: {
    ...
    transactionType: {headerName: 'atms.actionType', field: 'transactionType', width: 140,suppressSizeToFit: true,cellRendererFramework: AgTranslateMapComponent},
    amount: {headerName: 'atms.amount', field: 'amount', width: 110,suppressSizeToFit: true,cellRendererFramework: AgAmountComponent},
    transactionStatus: {headerName: 'atms.transactionStatus', field: 'transactionStatus', width: 180,suppressSizeToFit: true,cellRendererFramework: AgStatusComponent},
